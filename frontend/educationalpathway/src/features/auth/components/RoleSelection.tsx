    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-muted-foreground max-w-md mx-auto text-sm md:text-base font-bold uppercase tracking-[0.2em]">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          <Link href="/register?role=student" className="group">
            <div className="h-full bg-card rounded-2xl border border-border shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 relative overflow-hidden">
              ...
              <div className="p-10">
                ...
                {/* Action */}
                <div className="flex items-center justify-center w-full h-14 rounded-2xl bg-foreground text-background font-black text-xs uppercase tracking-[0.2em] transition-all group-hover:bg-primary group-hover:text-white">
                  Enter as Student
                </div>
              </div>
            </div>
          ...
          <Link href="/register?role=counselor" className="group">
            <div className="h-full bg-card rounded-2xl border border-border shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 relative overflow-hidden">
              ...
              <div className="p-10">
                ...
                {/* Action */}
                <div className="flex items-center justify-center w-full h-14 rounded-2xl bg-foreground text-background font-black text-xs uppercase tracking-[0.2em] transition-all group-hover:bg-indigo-500 group-hover:text-white">
                  Enter as Counselor
                </div>
              </div>
            </div>
