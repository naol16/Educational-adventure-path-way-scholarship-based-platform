...
class PayoutRequestBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PayoutRequestBottomSheet> createState() =>
      _PayoutRequestBottomSheetState();
}

class _PayoutRequestBottomSheetState
    extends ConsumerState<PayoutRequestBottomSheet> {
            ...
            children: [
              ...
              _buildTextField(
                ...
                validator: (v) {
                  ...
                  if (_selectedCurrency == 'ETB' && amt > availableEtb)
                    return 'Insufficient balance';
                  if (_selectedCurrency == 'USD' && amt > availableUsd)
                    return 'Insufficient balance';
                  return null;
                },
              ),
