...
class StudentBookingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<StudentBookingsScreen> createState() =>
      _StudentBookingsScreenState();
}
              ...
              final past =
                  bookings.where((b) {
                    return [
                        ...
                        (b.status == 'confirmed' &&
                            b.slot != null &&
                            b.slot!.endTime.isBefore(now));
                  }).toList()..sort(
                    (a, b) => (b.slot?.startTime ?? DateTime(0)).compareTo(
                      a.slot?.startTime ?? DateTime(0),
                    ),
                  );
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: booking.meetingLink != null
                            ? () => _startMeeting(context, booking)
                            : null,
                        icon: const Icon(LucideIcons.video, size: 18),
                        label: Text(
                          isOngoing ? "JOIN SESSION NOW" : "Join Meeting",
                        ),
