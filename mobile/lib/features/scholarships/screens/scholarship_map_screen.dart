...
class ScholarshipMapScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ScholarshipMapScreen> createState() => _ScholarshipMapScreenState();
}
      ...
      child: GlassContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(LucideIcons.mapPin, size: 14, color: DesignSystem.subText(context)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text("VIEW DETAILS", style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1)),
              ),
            ),
          ],
        ),
              ...
              children: [
                ...
                Expanded(
                  child: GlassContainer(
                    ...
                    child: Row(
                      children: [
                        Icon(LucideIcons.globe, color: DesignSystem.primary(context), size: 18),
        ...
        .map((s) => Marker(
              ...
              onTap: () {
                ...
                _controller?.animateCamera(
                  CameraUpdate.newLatLngZoom(LatLng(s.latitude!, s.longitude!), 6),
                );
              },
